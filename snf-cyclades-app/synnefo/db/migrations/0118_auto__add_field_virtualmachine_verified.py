...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VirtualMachine.verified'
        db.add_column('db_virtualmachine', 'verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VirtualMachine.verified'
        db.delete_column('db_virtualmachine', 'verified')
